...
import FilterItem from './pastAuctionFilterItem';

const PastAuctionSidebar = ({ filterData, urlQueries }) => (

  <aside className="left col-xs-12 col-md-3" id="primaryAside">
    <h2 className="page-title col-xs-12 hidden-md">Past Auctions</h2>
...
export default PastAuctionSidebar;
