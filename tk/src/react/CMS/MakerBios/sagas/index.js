...
import {
  getMakerBiosWatchers,
  updateMakerBioWatchers
  // deleteMakerBioWatchers
} from './maker-bios'
...
export default function* root() {
  ...
  try {
    const allWatchers = [
      forkList(getMakerBiosWatchers),
      forkList(updateMakerBioWatchers)
      // forkList(deleteMakerBioWatchers)
    ]
    yield allWatchers
  }
  catch (e) {
