...
import EditorialsDetails from '../components/EditorialsDetails';

const EditorialsDetailsContainer = (props) => {
  try {
...
export default connect(mapStateToProps, mapDispatchToProps)(EditorialsDetailsContainer);
