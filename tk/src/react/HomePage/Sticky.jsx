...
const Sticky = (props) => {
  ...
  const imgSrc = !props.source.includes('http') ? `https://www.phillips.com/Xigen/image.ashx?path=${decodeURIComponent(this.props.source)}` : props.source;
  return (
    <div className="sticky" ref={ref}>
      <div className="sticky__header">
        <button className="sticky__close" onClick={onClose} type="button" />
      </div>
